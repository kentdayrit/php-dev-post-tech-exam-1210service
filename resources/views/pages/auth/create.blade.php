        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form method="POST" action="{{ route('auth.store') }}">
                ...
                <div class="form-outline mb-4">
                  ...
                  <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control form-control-lg" placeholder="Enter a name" />
                  @error('name')
                ...
                <div class="form-outline mb-3">
                  <label class="form-label" for="confirm">Confirmation Password</label>
                  <input type="password" id="password_confirmation" name="password_confirmation" class="form-control form-control-lg" placeholder="Enter confirmation password" />
